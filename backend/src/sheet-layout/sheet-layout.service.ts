...
const TARGET_OUTPUT_BYTES = 25 * 1024 * 1024;
const JPEG_QUALITY_STEPS = [72, 68, 64, 60, 56, 52, 48, 44, 40];
...
export const PATTERNS: SlotPattern[] = [
  buildPattern('18x23_8S', '8× Small (5.5×8.5)', '18x23', [
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5'],
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5'],
  ]),
  buildPattern('18x23_6M', '6× Medium (7.5×8.5)', '18x23', [
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
  ]),
  buildPattern('18x23_4L', '4× Large (8.5×11)', '18x23', [
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
  ]),
  buildPattern('18x23_2XL', '2× XL (11×17)', '18x23', [
    ['XL_11x17', 'XL_11x17'],
  ]),
  buildPattern('18x23_2L_4S', '2× Large + 4× Small', '18x23', [
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5'],
  ]),
  buildPattern('18x23_4S_2L', '4× Small + 2× Large', '18x23', [
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5'],
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
  ]),
  buildPattern('18x23_3M_4S', '3× Medium + 4× Small', '18x23', [
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5'],
  ]),
  buildPattern('18x23_4S_3M', '4× Small + 3× Medium', '18x23', [
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'SMALL_5_5x8_5'],
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
  ]),
  buildPattern('18x23_3M_2L', '3× Medium + 2× Large', '18x23', [
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
  ]),
  buildPattern('18x23_3M_2S_1L', '3× Medium + 2× Small + 1× Large', '18x23', [
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
    ['SMALL_5_5x8_5', 'SMALL_5_5x8_5', 'LARGE_8_5x11'],
  ]),
  buildPattern('18x23_2L_3M', '2× Large + 3× Medium', '18x23', [
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
  ]),
  buildPattern('18x23_1L2S_x2', '2× (1 Large + 2 Small)', '18x23', [
  ...
  buildPattern('19x25_6M', '6× Medium', '19x25', [
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
    ['MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5', 'MEDIUM_7_5x8_5'],
  ]),
  buildPattern('19x25_4L', '4× Large', '19x25', [
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
    ['LARGE_8_5x11', 'LARGE_8_5x11'],
  ]),
  buildPattern('19x25_2XL', '2× XL (11×18")', '19x25', [
    ['XL_11x17', 'XL_11x17'],
  ]),
];
...
export class SheetLayoutService {
  ...
  async assembleSheet(
    ...
    const renderAtQuality = (quality: number) =>
      sharp(baseBuffer)
    ...
    for (const quality of JPEG_QUALITY_STEPS) {
      const output = await renderAtQuality(quality);
      bestBuffer = output;
      if (output.length <= TARGET_OUTPUT_BYTES) return output;
    }
    return bestBuffer!;
  }
}
