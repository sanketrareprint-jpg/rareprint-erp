          ...
          <div className="flex min-h-0 min-w-0 flex-col gap-3">
              ...
              {goalHorizonOrder.map(goalHorizon => (
                <button
                  ...
                  className={`rounded-lg border px-3 py-2 text-left transition hover:border-blue-300 hover:shadow-sm ${
                    goalHorizonFilter === goalHorizon ? "border-brand-500 bg-brand-50 ring-1 ring-brand-200" : "border-slate-200 bg-white"
                  }`}
            ...
            <div className="flex flex-none flex-wrap items-center gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
              ...
              {goalHorizonFilter !== "ALL" && (
                <button onClick={() => setGoalHorizonFilter("ALL")} className="rounded-lg border border-brand-200 bg-brand-50 px-3 py-1.5 text-xs font-semibold text-brand-700 hover:bg-brand-100">
            ...
            {loading ? (
              ...
              <div className="flex flex-1 flex-col items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white p-10 text-center text-sm text-slate-400">
                ...
                {(quadrantFilter !== "ALL" || goalHorizonFilter !== "ALL") && (
                  <button onClick={() => { setQuadrantFilter("ALL"); setGoalHorizonFilter("ALL"); }} className="rounded-lg bg-brand-600 px-4 py-2 text-xs font-semibold text-white hover:bg-brand-700">
                    Show All Tasks
                  </button>
                )}
              </div>
                    ...
                    {editingId === task.id ? (
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <button onClick={() => saveEdit(task.id)} disabled={editSaving} className="inline-flex items-center gap-1 rounded-lg bg-brand-600 px-3 py-1.5 text-xs font-semibold text-white hover:bg-brand-700 disabled:opacity-60">
