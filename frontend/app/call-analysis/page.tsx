      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <section className="col-span-2 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <textarea value={transcript} onChange={(e) => setTranscript(e.target.value)} placeholder="Transcript appears here word by word while audio plays." className="h-64 w-full rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm leading-6 text-slate-700" />
