    ...
    <footer className="border-t border-slate-200 bg-slate-950 text-slate-300">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-[1.3fr_1fr]">
          <div>
            <span className="inline-block rounded-full bg-brand-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-brand-400">
              Print business ERP
            </span>
            ...
            <div className="mt-5 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={whatsappLink()} target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-white hover:text-brand-300">
                    Message us
                  </a>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${CONTACT_EMAIL}`} className="text-sm font-semibold text-white hover:text-brand-300">
                    {CONTACT_EMAIL}
                  </a>
                </div>
              </div>
