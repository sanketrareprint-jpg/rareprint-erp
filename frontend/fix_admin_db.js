...
const content = `import { Controller, Get, Post, Body, Param } from '@nestjs/common';
...
fs.writeFileSync('C:\\Users\\ZEB\\Desktop\\print-erp-git\\backend\\src\\admin-db.controller.ts', content, 'utf8');
console.log('Done - file written correctly');
