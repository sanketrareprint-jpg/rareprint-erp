          ...
          {leadFeatures.map((feature, i) => {
            ...
            return (
              <FadeIn key={feature.slug} delay={i * 70}>
                <div className="group rounded-xl border border-slate-200 bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
          ...
          {moreFeatures.map((feature, i) => {
            ...
            return (
              <FadeIn key={feature.slug} delay={i * 60}>
                <div className="group rounded-xl border border-slate-200 bg-white p-5 transition-all duration-300 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
