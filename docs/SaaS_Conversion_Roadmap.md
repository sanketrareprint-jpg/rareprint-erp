...
## 6. Security hardening & repo hygiene
...
## 8. Legal / commercial (non-code, but blocking before you sell)

- Terms of Service, Privacy Policy, Data Processing Agreement.
- Published pricing/plans page.
...
6. Superadmin console
7. Frontend branding + billing UI
8. Repo hygiene / split non-product folders out
9. Security audit with dummy multi-tenant staging data before first real customer
...
Once Phase 1 is reviewed and merged, come back and I'll write the Phase 2 prompt (module-by-module tenant-scoping audit) and the billing/subscription prompt.
